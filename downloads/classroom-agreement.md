...
- [add your class specifics]

## When we CANNOT use AI in this class
- [e.g., copying AI output as our own, using it on graded assessments without permission]
- [add your class specifics]

## Discussion questions (for co-creating this)
- Why is it important to be honest about using AI?
- What's the difference between using a tool and passing off work that isn't yours?
- What could go wrong if we typed our names or school into an AI?
- How can AI help you learn, and how can it hurt your learning if you rely on it?

## Sign-off
By signing, I agree to follow these rules.
- Student: ______________________  Date: ________
- Student: ______________________  Date: ________
- Teacher: ______________________  Date: ________

*Review and update this agreement together each semester.*
